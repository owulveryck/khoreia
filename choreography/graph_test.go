...
func TestRun(t *testing.T) {
	...
	caCert, err := ioutil.ReadFile("./test/choreography.pem")
	if err != nil {
		t.Fatal(err)
	...
	exe := ExecutorBackend{
		...
		"./test/choreography.pem",
		"./test/choreography_key.pem",
		"./test/executor.pem",
		"/ping",
		nil,
	}
...
func BenchmarkRun(b *testing.B) {
	...
	exe := ExecutorBackend{
		...
		"./security/certs/choreography/choreography.pem",
		"./security/certs/choreography/choreography_key.pem",
